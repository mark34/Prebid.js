...
describe('ozone Adapter', function () {
  ...
  describe('interpretResponse', function () {
    ...
    it('should add unique adId values to each bid', function() {
      ...
      expect(result[0]['adserverTargeting']['oz_ozone_adId']).to.equal('2899ec066a91ff8-0-oz-1'); // consolidating
    });
    it('should correctly process an auction with 2 adunits & multiple bidders one of which bids for both adslots', function() {
      ...
      expect(result[3]['impid']).to.equal('3025f169863b7f8');
      expect(result[3]['id']).to.equal('18552976939844999');
      expect(result[3]['price']).to.equal(0.521);
      expect(result[3]['adserverTargeting']['oz_ozone_adId']).to.equal('3025f169863b7f8-0-oz-2');
      ...
      expect(result[3]['price']).to.equal(1.1);
      expect(result[3]['impid']).to.equal('3025f169863b7f8');
      expect(result[3]['id']).to.equal('18552976939844681');
      expect(result[3]['adserverTargeting']['oz_ozone_adId']).to.equal('3025f169863b7f8-0-oz-1');
    });
  ...
  describe('consolidateOzoneBids', function () {
    beforeEach(function () {
      config.resetConfig()
    })
